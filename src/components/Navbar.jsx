...
import { LucideTicketPlus, MenuIcon, SearchIcon, XIcon } from 'lucide-react';
...
const Navbar = () => {
  ...
  // ⛔️ Don't render navbar until Clerk is ready
        ...
        {user ? (
          <UserButton>
            <UserButton.MenuItems>
              <UserButton.Action label="My Bookings" labelIcon={<LucideTicketPlus width={15}/>} onClick={()=> navigate('/my-bookings')}/>
            </UserButton.MenuItems>
          </UserButton>
        ) : (
          <button
