...
const HeroSection = () => {
  ...
  return (
    ...
    lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <p className='max-w-md text-gray-300'>In apost-appocalyptic world where cities ride on wheels and 
            consume each other to survive, two people meet
            in london and try to stop a consipiracy.
        </p>
